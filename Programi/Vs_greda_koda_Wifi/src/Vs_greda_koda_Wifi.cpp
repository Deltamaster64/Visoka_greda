...
const int senzor1 = 39;
const int senzor2 = 34;
const int senzor3 = 35;
const int senzor4 = 32;
const int senzor5 = 33;
const int senzor6 = 36;
...
#define DHTPIN 13 //prej je bil 13
...
void loop(){
  ...
  Serial.print(M);
  Serial.print(" TRISE: ");
  print_min_in_format_hm(trise);
  Serial.print(" TSET: ");
  print_min_in_format_hm(tset);
