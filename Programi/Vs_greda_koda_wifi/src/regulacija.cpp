...
void sun_rise_set(int day,int year,int month,int *trise,int *tset){
  ...
  int avg1 = 410; //povprečni čas sončnega vzhoda
  int dif1 = 154; //razlika najhitrejšega in najkasnejšega časa vzhoda

  *trise = avg1 + 0.5 * dif1 * cos((doy+8) / 58.09);

  int avg2 = 1136; //povprečni čas sončnega zahoda
  int dif2 = 281; //razlika najhitrejšega in najkasnejšega časa zahoda 
...
void print_min_in_format_hm(int time){
